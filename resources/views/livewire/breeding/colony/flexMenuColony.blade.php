  ...
  <div class="row">
    ...
    <div class="col-lg-2 col-6">
      ...
      <div class="small-box bg-info">
        ...
        <a href="/add-mating" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
      </div>
    </div>
    <!-- ./col -->
    ...
    <div class="col-lg-2 col-6">
      ...
      <div class="small-box bg-info">
        ...
        <a href="/add-litter" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
      </div>
    </div>
    <!-- ./col -->
    ...
    <div class="col-lg-2 col-6">
      ...
      <div class="small-box bg-warning">
        ...
        <a href="/edit-litter" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
      </div>
    </div>
    <!-- ./col -->
